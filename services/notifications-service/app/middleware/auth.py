...
def get_user_permissions(current_user: Dict[str, Any]) -> Dict[str, bool]:
    ...
    permissions = {
        "can_send_notifications": is_verified,
        "can_view_own_notifications": True,
        "can_view_all_notifications": role == "admin",
        "can_manage_templates": role in ["admin", "marketing"],
        "can_send_bulk_notifications": role in ["admin", "marketing"],
        "can_access_analytics": role in ["admin", "analytics"],
        "can_manage_preferences": True,
        "can_view_delivery_status": is_verified
    }
