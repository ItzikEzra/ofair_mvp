-- Update the get_client_details_for_proposal function to accept token parameter
CREATE OR REPLACE FUNCTION public.get_client_details_for_proposal(proposal_id_param uuid, proposal_type_param text, token_param text DEFAULT NULL)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
